...
const descriptor = {
  ...
  // Fork-required identity fields (see docs/upstream/BASELINE.md); upstream's
  // own fixture omits them, so every sync re-adds them here.
  fork: "T3 Trade",
  t3UpstreamCommit: "3b72d17cbca691f0b64e6d4a10c9e349f42873a5",
