...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("trading.mission-create-requested"),
    payload: TradingMissionCreateRequestedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("trading.mission-status-changed"),
    payload: TradingMissionStatusChangedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("trading.mission-strategy-published"),
    payload: TradingMissionStrategyPublishedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("trading.mission-watch-registered"),
    payload: TradingMissionWatchRegisteredPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("trading.mission-watch-cancelled"),
    payload: TradingMissionWatchCancelledPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("trading.mission-watch-fired"),
    payload: TradingMissionWatchFiredPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
