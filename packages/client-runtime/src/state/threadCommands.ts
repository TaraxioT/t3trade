...
import {
  ...
  type SetThreadWorkspaceModeInput,
  type PinThreadInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setWorkspaceMode: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-workspace-mode",
      execute: (input: SetThreadWorkspaceModeInput) => setThreadWorkspaceMode(input),
      scheduler,
      concurrency,
    }),
