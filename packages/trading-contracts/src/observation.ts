...
export const TRADING_LOOK_CATALOG: ReadonlyArray<TradingLookCatalogEntry> = [
  ...
  { key: "indicators", chars: 40, parameterized: "<spec>", note: "~125 for a pair" },
  { key: "volatility", chars: 677 },
  { key: "volatility_htf", chars: 680 },
  { key: "structure", chars: 4375 },
  { key: "structure_brief", chars: 420, note: "estimated; alignment + top candidate" },
  { key: "funding_stats", chars: 140, parameterized: "<W>", archive: true },
  { key: "funding_series", chars: 28, parameterized: "<n>", archive: true },
  { key: "oi_premium", chars: 55, parameterized: "<n>", archive: true },
  { key: "book_history", chars: 48, parameterized: "<n>", archive: true },
