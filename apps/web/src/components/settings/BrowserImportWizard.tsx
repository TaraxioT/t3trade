...
function FullDiskAccessStep({
  ...
  return (
    <>
      <DialogHeader>
        <DialogTitle>Let T3 Trade read {source.name}&rsquo;s cookies</DialogTitle>
        <DialogDescription>
          To import cookies from {source.name}, T3 Trade needs Full Disk Access. Turn it on in
      ...
      {stillRequired ? (
        <DialogPanel>
          <p role="status" className="text-sm text-muted-foreground">
            Full Disk Access is still required. If you just turned it on, quit and reopen T3 Trade,
            then try again.
          </p>
        </DialogPanel>
      ) : null}
