...
export function WelcomeWizard({
  ...
  return (
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <DialogTitle className="sr-only">Set up T3 Trade</DialogTitle>
        <div className="flex min-h-0 flex-col">
          <DialogHeader className="gap-4">
            <div className="flex items-baseline gap-1.5" role="img" aria-label="T3 Trade">
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            Keep T3 Trade running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start T3 Trade first, or run <code className="font-mono">npx t3 serve</code>. Add{" "}
