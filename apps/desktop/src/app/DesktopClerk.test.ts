...
const makeDesktopClerkLayer = (isDevelopment = true, events: string[] = []) => {
  const environment = DesktopEnvironment.DesktopEnvironment.of({
    ...
    userDataDirName: isDevelopment ? "t3trade-dev" : "t3trade",
    legacyUserDataDirName: isDevelopment ? "T3 Trade (Dev)" : "T3 Trade (Alpha)",
...
describe("DesktopClerk", () => {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "t3trade-dev", host: "app" },
          },
        ],
      ]);
  ...
  it.each([
    { isDevelopment: true, scheme: "t3trade-dev" },
    { isDevelopment: false, scheme: "t3trade" },
