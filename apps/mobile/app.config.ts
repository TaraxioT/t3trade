    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active T3 Trade agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow T3 Trade to connect to T3 Trade servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow T3 Trade to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow T3 Trade to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow T3 Trade to access your camera so you can scan pairing QR codes.",
