import {
  ...
  ThreadWorkspaceModeSetPayload as ContractsThreadWorkspaceModeSetPayloadSchema,
...
export const ThreadWorkspaceModeSetPayload = ContractsThreadWorkspaceModeSetPayloadSchema;
